var multiplicaciones = {
    ...
    iniciar: function (minimo, maximo) {
        ...
        $('#boton').on('click', function(){multiplicaciones.comenzar(minimo, maximo)});          
        $('#ingreso').on('keypress', function(e){multiplicaciones.verificar(e)});   
    ...
    verificar: function (e) {
        ...
        if (this.contadorDePreguntas<this.cantidadDePreguntas) {
            setTimeout(function(){ multiplicaciones.preguntar() }, this.tiempoEntrePreguntas*1000)
        }
        else {
            setTimeout(function(){ multiplicaciones.mostrarFinal() }, this.tiempoEntrePreguntas*1000)
        }
    },
